...
public class Benutzerschnittstelle extends JFrame
{
	...
	private JLabel lblDoppelpunkt;
	private JLabel lblMinuten;
	private JLabel lblStunden;
	private JLabel lblWeckfunktion;
	private JLabel lblZeitart;

	public class AlarmThread extends Thread
	{
		public void run()
		{
			Color hintergrundfarbe = contentPane.getBackground();
			while (aktivAlarm)
			{
	...
	{
		String mm = String.format("%02d", pMinuten);
	...
	{
		String hh = String.format("%2d", pStunden);
	...
	public void zeigeZeitart(char pZeitart)
	{
		...
		{
			case 'A':
				lblZeitart.setText("aktuelle Zeit");
				break;
			case 'W':
				lblZeitart.setText("Weckzeit");
				break;
		}
	}
}
